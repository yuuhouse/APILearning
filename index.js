...
let urlBack = '&APPID=70c39d518ced5d61d33cdc9295f08f83&lang=zh-tw&units=metric'
...
function makeRequest() {
  ...
  xhr.onload = function () {
    ...
    var weatherContainer = document.querySelector('#weather') //選取ID這樣才知道要寫入哪裡
  ...
  /* xhr.open(
    'GET',
    'https://api.openweathermap.org/data/2.5/forecast?q=taipei,tw&APPID=70c39d518ced5d61d33cdc9295f08f83&lang=zh-tw&lang=zh_tw&units=metric',
    true,
  ) */
